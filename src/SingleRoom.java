...
public class SingleRoom extends Reservation {

    public SingleRoom(String guestName, String roomID) {
    ...
    public void checkIn() {
        isCheckedIn = true;
        System.out.println("\nSingle room " + roomID + " checked in for guest " + guestName + ".");
    }

    @Override
    public void checkOut() {
        isCheckedIn = false;
        System.out.println("Single room " + roomID + " checked out for guest " + guestName + ".\n");
    }
